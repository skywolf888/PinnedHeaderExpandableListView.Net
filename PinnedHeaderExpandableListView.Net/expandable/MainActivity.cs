...
using R = PinnedHeaderExpandableListView.Net.Resource;
        ...
        class MyexpandableListAdapter : BaseExpandableListAdapter
        {
                    ...
                    View convertView, ViewGroup parent)
            {
                ...
                if (convertView == null)
                {
                    ...
                    convertView.SetTag(1,groupHolder);
                }
                else
                {
                    groupHolder = (GroupHolder)convertView.GetTag(1);
                }
                    ...
                    bool isLastChild, View convertView, ViewGroup parent)
            {
                ...
                if (convertView == null)
                {
                    ...
                    button.Click += delegate { 
                        Toast.MakeText(this.context, "clicked pos=", ToastLength.Short).Show();
                    };

                    convertView.SetTag(0,childHolder);
                }
                else
                {
                    childHolder = (ChildHolder)convertView.GetTag(0);
                }
